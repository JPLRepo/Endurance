...
namespace Endurance
{
    ...
    /// </summary>
    public class ENAnimateControlled : PartModule
    {
        ...
        public static ENAnimateControlled locateAnimationController(Part part, int id, Action<AnimState> callback)
        {
            if (id < 0)
            {
                return null;
            }
            ENAnimateControlled[] potentialAnimators = part.GetComponents<ENAnimateControlled>();
            foreach (ENAnimateControlled ac in potentialAnimators)
            {
